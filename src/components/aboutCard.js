                    ...
                    <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-1 lg:grid-cols-3">
                        {links.map((link) => (
                            <Link key={link.name} href={link.link}>
                                <div className="flex flex-row text-white font-dText border-solid border border-white/30 rounded p-6 justify-between items-center hover:bg-white/10 cursor-pointer">
